...
fn test_bitwise_and_compilation() {
    ...
    println!("   Compiled {} AND instructions", stats.instruction_counts["And"]);
}
...
fn test_bitwise_or_compilation() {
    ...
    println!("   Compiled {} OR instructions", stats.instruction_counts["Or"]);
}
...
fn test_bitwise_xor_compilation() {
    ...
    println!("   Compiled {} XOR instructions", stats.instruction_counts["Xor"]);
}
