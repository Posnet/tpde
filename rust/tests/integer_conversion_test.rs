...
fn create_sext_test(context: &Context) -> inkwell::module::Module {
    ...
    let result = builder
        .build_int_s_extend(value, i32_type, "result")
        .unwrap();
    ...
    let value = function.get_nth_param(0).unwrap().into_int_value();
    let result = builder
        .build_int_s_extend(value, i64_type, "result")
        .unwrap();
    builder.build_return(Some(&result)).unwrap();
...
fn create_zext_test(context: &Context) -> inkwell::module::Module {
    ...
    let value = function.get_nth_param(0).unwrap().into_int_value();
    let result = builder
        .build_int_z_extend(value, i32_type, "result")
        .unwrap();
    builder.build_return(Some(&result)).unwrap();
    ...
    let value = function.get_nth_param(0).unwrap().into_int_value();
    let result = builder
        .build_int_z_extend(value, i64_type, "result")
        .unwrap();
    builder.build_return(Some(&result)).unwrap();
...
fn create_trunc_test(context: &Context) -> inkwell::module::Module {
    ...
    let value = function.get_nth_param(0).unwrap().into_int_value();
    let result = builder
        .build_int_truncate(value, i32_type, "result")
        .unwrap();
    builder.build_return(Some(&result)).unwrap();
    ...
    let value = function.get_nth_param(0).unwrap().into_int_value();
    let result = builder
        .build_int_truncate(value, i8_type, "result")
        .unwrap();
    builder.build_return(Some(&result)).unwrap();
    ...
    let value = function.get_nth_param(0).unwrap().into_int_value();
    let result = builder
        .build_int_truncate(value, i1_type, "result")
        .unwrap();
    builder.build_return(Some(&result)).unwrap();
...
fn create_complex_conversion_test(context: &Context) -> inkwell::module::Module {
    ...
    let value = function.get_nth_param(0).unwrap().into_int_value();
    let temp16 = builder
        .build_int_s_extend(value, i16_type, "temp16")
        .unwrap();
    let temp32 = builder
        .build_int_s_extend(temp16, i32_type, "temp32")
        .unwrap();
    let result = builder
        .build_int_s_extend(temp32, i64_type, "result")
        .unwrap();
    builder.build_return(Some(&result)).unwrap();
...
fn test_sext_compilation() {
    ...
    compiler
        .compile_function_by_name("test_sext_i8_to_i32")
        .unwrap();
    compiler
        .compile_function_by_name("test_sext_i16_to_i64")
        .unwrap();
    compiler
        .compile_function_by_name("test_sext_i32_to_i64")
        .unwrap();
    ...
    println!(
        "   Compiled {} SEXT instructions",
        stats.instruction_counts["SExt"]
    );
}
...
fn test_zext_compilation() {
    ...
    // Compile all functions
    compiler
        .compile_function_by_name("test_zext_i8_to_i32")
        .unwrap();
    compiler
        .compile_function_by_name("test_zext_i32_to_i64")
        .unwrap();
    compiler
        .compile_function_by_name("test_zext_i1_to_i32")
        .unwrap();
    ...
    println!(
        "   Compiled {} ZEXT instructions",
        stats.instruction_counts["ZExt"]
    );
}
...
fn test_trunc_compilation() {
    ...
    // Compile all functions
    compiler
        .compile_function_by_name("test_trunc_i64_to_i32")
        .unwrap();
    compiler
        .compile_function_by_name("test_trunc_i32_to_i8")
        .unwrap();
    compiler
        .compile_function_by_name("test_trunc_i32_to_i1")
        .unwrap();
    ...
    println!(
        "   Compiled {} TRUNC instructions",
        stats.instruction_counts["Trunc"]
    );
}
...
fn test_complex_conversion_chain() {
    ...
    compiler
        .compile_function_by_name("sign_extend_chain")
        .unwrap();
...
fn test_mixed_conversions() {
    ...
    let truncated = builder
        .build_int_truncate(x, i32_type, "truncated")
        .unwrap();
    let extended = builder.build_int_s_extend(y, i32_type, "extended").unwrap();
    let result = builder
        .build_int_add(truncated, extended, "result")
        .unwrap();
    builder.build_return(Some(&result)).unwrap();
